...
public class LoginServlet extends BaseServlet
    {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                throws ServletException, IOException
            {
                ...
                if (state == null)
                    {
                        session.invalidate();
                        getServletContext().getRequestDispatcher("/WEB-INF/login/login_form.jsp").forward(request,
                                response);
                        return;
                    }
                ...
                if (user != null)
                    {
                        ...
                        getServletContext().getRequestDispatcher("/WEB-INF/login/login_error.jsp").forward(request,
                                response);
                        return;
                    }
         ...
         */
        private void procTop(HttpServletRequest request, HttpServletResponse response, HttpSession session,
                UserBean user) throws ServletException, IOException
            {
         ...
         * @param user      ログイン中のユーザー情報
         */
        private void procLogout(HttpServletRequest request, HttpServletResponse response, HttpSession session,
                UserBean user) throws ServletException, IOException
            {
                if ((user == null) || (user.getName() == null))
                    {
