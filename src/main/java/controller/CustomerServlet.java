...
public class CustomerServlet extends BaseServlet
    {
         ...
         */
        private void procSearch(HttpServletRequest request, HttpServletResponse response)
                throws ServletException, IOException
            {
         ...
         */
        private void procDetail(HttpServletRequest request, HttpServletResponse response, HttpSession session,
        ...
        private void procAdd(HttpServletRequest request, HttpServletResponse response, HttpSession session)
                throws ServletException, IOException
            {
                ...
                if (errMessage == null)
                    {
                        getServletContext().getRequestDispatcher("/WEB-INF/customer/add_success.jsp").forward(request,
                                response);
                    } else
                    {
                        session.setAttribute("errMessage", errMessage);
                        getServletContext().getRequestDispatcher("/WEB-INF/customer/add_fail.jsp").forward(request,
                                response);
                    }
        ...
        private void procDelete(HttpServletRequest request, HttpServletResponse response, HttpSession session)
                throws ServletException, IOException
            {
                ...
                if (errMessage == null)
                    {
                        getServletContext().getRequestDispatcher("/WEB-INF/customer/delete_success.jsp")
                                .forward(request, response);
                    } else
                    {
                        getServletContext().getRequestDispatcher("/WEB-INF/customer/delete_fail.jsp").forward(request,
                                response);
                    }
        ...
        private void procEditConfirm(HttpServletRequest request, HttpServletResponse response)
                throws ServletException, IOException
            {
                ...
                getServletContext().getRequestDispatcher("/WEB-INF/customer/edit_confirm.jsp").forward(request,
                        response);
            }
         ...
         * @param response  HTTPのレスポンス
         */
        private void procNewConfirm(HttpServletRequest request, HttpServletResponse response)
                throws ServletException, IOException, UnsupportedEncodingException
            {
                ...
                getServletContext().getRequestDispatcher("/WEB-INF/customer/new_confirm.jsp").forward(request,
                        response);
            }
    }
