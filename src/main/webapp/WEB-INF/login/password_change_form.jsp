...
<body>
	<h1>パスワード変更</h1>
	<div class="main">
		<form name="form1" action="PasswordChangeServlet" method="post" onsubmit="return funcConfirmPassword()">
			<table>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="password" name="new_password1" maxlength="15">
					</td>
				</tr>
				<tr>
					<td class="title">新パスワード（確認用）</td>
					<td>
						<input type="password" name="new_password2" maxlength="15">
					</td>
				</tr>
			</table>
			<p>
