...
<body>
	...
	<div class="main">
		<h2>CSV操作</h2>
		<form name="form1" action="CustomerCsvServlet" method="post" onsubmit="return funcConfirm1()">
			<p>
				<button name="state" value="read">一括処理</button>
				<input type="file" name="filepath1">
			</p>
		</form>
		<form name="form2" action="CustomerCsvServlet" method="post" onsubmit="return funcConfirm2()">
			<p>
