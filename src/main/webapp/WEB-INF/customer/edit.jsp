			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="zip" maxlength="10"
						inputmode="numeric" value="<%=customer.getZip()%>"></td>
				</tr>
				<tr>
					<td class="title">住所1</td>
					<td><input type="text" name="address1" maxlength="98"
						value="<%=customer.getAddress1()%>"></td>
				</tr>
				<tr>
					<td class="title">住所2</td>
					<td><input type="text" name="address2" maxlength="98"
						value="<%=customer.getAddress2()%>"></td>
				</tr>
				<tr>
					<td class="title">TEL</td>
					<td><input type="text" name="tel" maxlength="20"
						inputmode="tel" value="<%=customer.getTel()%>"></td>
				</tr>
				<tr>
					<td class="title">FAX</td>
					<td><input type="text" name="fax" maxlength="20"
						inputmode="tel" value="<%=customer.getFax()%>"></td>
				</tr>
				<tr>
					<td class="title">Email</td>
					<td><input type="text" name="email" maxlength="50"
						inputmode="email" value="<%=customer.getEmail()%>"></td>
				</tr>
			</table>
